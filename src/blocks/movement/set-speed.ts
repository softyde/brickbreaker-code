...
const block: BlockDefinition = {
    def: {
        type: 'move_set_speed',
        message0: 'movement.set-speed.message',
        ...
        args0: [
            ...
            },
            {
                type: 'input_value',
                name: 'VAR_SPEED',
                check: ['Number', shadowNumber('speed', 100, 1, 1000, 1)],
            },
        ],
    },
    func: (block, generator) => {
        ...
        const distance = generator.statementToCode(block, 'VAR_SPEED').trim();

        return `${driveVar}.settings(straight_speed=${distance})`;
    },
};
