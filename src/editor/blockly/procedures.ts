...
// import type { PythonGenerator } from 'blockly/py';
// import { Order } from './python_generator.js';

export type IfReturnBlock = Blockly.Block & IfReturnMixin;
interface IfReturnMixin {
    // extends IfReturnMixinType {
...
export function procedures_defreturn(block: Blockly.Block, generator: PythonGenerator) {
...
export function procedures_ifreturn(block: Blockly.Block, generator: PythonGenerator) {
